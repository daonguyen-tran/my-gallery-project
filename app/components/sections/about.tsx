    ...
    <section id="about" className="py-24 px-6 bg-gray-50">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-gray-700 text-lg leading-relaxed">
          Bonjour, je suis Daonguyen TRAN. Cette galerie présente une sélection
          professionnelle d'albums photographiques destinés aux projets,
          portfolios et présentations commerciales. Chaque album met en valeur
          un travail soigné, pensé pour la clarté visuelle et la narration.
        </p>

        <p className="text-gray-600 text-lg leading-relaxed mt-4">
          Ce site sert également de vitrine technique : il a été développé avec
